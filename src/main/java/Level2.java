...
public class Level2 {
    ...
    public Level2() {
        ...
        bricks.add(new Brick(44, 3, BrickType.PADDLE_SIZE_INCREASE));
        bricks.add(new Brick(51, 3, BrickType.PADDLE_SIZE_DECREASE));
        ...
        bricks.add(new Brick(23, 5, BrickType.PADDLE_SIZE_INCREASE));
        ...
        bricks.add(new Brick(72, 5, BrickType.PADDLE_SIZE_INCREASE));
        ...
        bricks.add(new Brick(2, 7, BrickType.BALL_SPEED_INCREASE));
        ...
        bricks.add(new Brick(93, 7, BrickType.BALL_SPEED_INCREASE));
        ...
        bricks.add(new Brick(37, 9, BrickType.BALL_SPEED_INCREASE));
        bricks.add(new Brick(44, 9, BrickType.NORMAL));
        bricks.add(new Brick(51, 9, BrickType.NORMAL));
        bricks.add(new Brick(58, 9, BrickType.BALL_SPEED_INCREASE));
        ...
        bricks.add(new Brick(2, 11, BrickType.PADDLE_SIZE_DECREASE));
        ...
        bricks.add(new Brick(93, 11, BrickType.PADDLE_SIZE_INCREASE));
        ...
        bricks.add(new Brick(9, 15, BrickType.NORMAL));
        bricks.add(new Brick(16, 15, BrickType.NORMAL));
        //bricks.add(new Brick(23, 13, BrickType.NORMAL));
        //bricks.add(new Brick(30, 13, BrickType.NORMAL));
        bricks.add(new Brick(37, 15, BrickType.NORMAL));
        bricks.add(new Brick(44, 15, BrickType.PADDLE_SIZE_DECREASE));
        bricks.add(new Brick(51, 15, BrickType.PADDLE_SIZE_INCREASE));
        bricks.add(new Brick(58, 15, BrickType.NORMAL));
        //bricks.add(new Brick(65, 13, BrickType.NORMAL));
        //bricks.add(new Brick(72, 13, BrickType.NORMAL));
        bricks.add(new Brick(79, 15, BrickType.NORMAL));
        bricks.add(new Brick(86, 15, BrickType.NORMAL));
        bricks.add(new Brick(93, 15, BrickType.NORMAL));
    }
}
