...
public class Level3 {
    /*public static void main(String[] args) throws IOException {
...

        {
            ...
            bricks.add(new Brick(42, 9, BrickType.PADDLE_SIZE_DECREASE));
            ...
            bricks.add(new Brick(2, 18, BrickType.PADDLE_SIZE_DECREASE));
            ...
            bricks.add(new Brick(74, 18, BrickType.NORMAL));
            bricks.add(new Brick(82, 18, BrickType.PADDLE_SIZE_DECREASE));
